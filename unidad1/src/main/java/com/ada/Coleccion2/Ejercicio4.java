   ...
   //Sin lanzar la excepción, no funciona el programa con un FileWriter
    public static void main(String[] args) throws IOException {
        ...
        try{
            ...
            //El br.readLine() lo metemmos en un string que va a contener la línea leída para después imprimirlo.
            //ESTE YA LEE LÍNEA A LÍNEA. Para hacerlo caracter a carácter a carácter usar br.read()
            String linea;
